                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                          ...
                          <span className="font-semibold text-foreground mb-2 text-2xl font-bold tracking-tight text-heading">{sub.title}</span>
                          <span className="text-muted-foreground mb-6 text-body"> - {sub.description}</span>
